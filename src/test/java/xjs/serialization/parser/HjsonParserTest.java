...
public final class HjsonParserTest extends CommonParserTest {
    ...
    @Test
    public void parse_noValueForLastKey_isEmptyString() throws IOException {
        assertTrue(new JsonObject().add("k", "")
            .matches(this.parse("k:")));
    }

    @Test
    public void parse_toleratesWhitespace_afterKey() throws IOException {
    ...
    @Test
    public void emptyFile_isImplicitlyAnObject() throws IOException {
    ...
    @Test
    public void parseValue_readsUntilNewLines() throws IOException {
